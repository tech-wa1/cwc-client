            ...
            <div className="lg:flex lg:pt-24 items-start justify-evenly lg:m-auto">
                ...
                <div className="py-3 lg:w-5/12">
                    ...
                    <ul className="px-3 tracking-wide">
                        <li className="py-1">This confidential assessment is designed to gather your honest feedback to help drive meaningful improvements. Your unique perspectives are invaluable, and your input will provide us with essential insights. Remember, there are no right or wrong answers—what matters most is your genuine opinion.</li>
                        <li className="py-1">Please read each question thoroughly and choose the option that best reflects your perspective.</li>
                        <li className="py-1">The survey typically takes around 15 minutes to complete. We recommend finishing it in one sitting for the best experience.</li>
                        <li className="py-1">Your progress is shown at the top of each page. Use the
                        ...
                        <li className="py-1">Questions marked with the icon <InfoCircleOutlined /> will offer additional details about the question and its intended outcomes.</li>
                        <li className="py-1">At the end of the survey, please click
                            <Button type="primary" size="small" className="px-5 h-6 mx-2 text-xs">Submit</Button>
                            to ensure your responses are recorded.</li>
                        <li className="py-1">Your individual responses will be kept confidential and will only be utilized in aggregate form.</li>
                        ...
                        <li className="py-1">Please remember that your honest feedback is invaluable and will play a significant role in enhancing the workplace.</li>
                    </ul>
                </div>
            </div>
